...
def build_tables():
    ...
    fid = [r"\begin{table}[!tbp]", r"\centering",
           ...
           r"frozen from clean validation spend nearly two thirds more or",
           r"less compute than the deployment was given. The quantile column",
